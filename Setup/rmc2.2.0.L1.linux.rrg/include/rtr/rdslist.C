...
template<class T>
void RTRDescSortedList<T>::extend(T *newT)
{
	RTPRECONDITION ( newT );
...
template<class T>
void RTRDescSortedList<T>::extendFromBehind(T *newT)
{
	RTPRECONDITION ( newT );
	RTRLinkElement *newLink = new RTRLinkElement(newT);
	RTRLinkElement *l;
...
template<class T>
RTRBOOL RTRDescSortedList<T>::has(T *t) const
{
	RTPRECONDITION ( t );
...
template<class T>
void RTRDescSortedList<T>::deleteContents()
{
...
template<class T>
void RTRDescSortedList<T>::wipeOut()
{
	while (_link = _list.first())
	{
		_list.remove(_link);
...
template<class T>
void RTRDescSortedList<T>::remove(T *t)
{
	RTRLinkElement *l;
...
template<class T>
void RTRDescSortedList<T>::search(T *t)
{
