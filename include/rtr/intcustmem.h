...
#define ALIGNMENT(v) ((rtrUIntPtr)v & 0x03)
#define ALIGN4BYTE(v) ((rtrUIntPtr)v & 0x03)
#define ALIGN8BYTE(v) ((rtrUIntPtr)v & 0x07)
...
{
	register size_t bytestoalign = alignbytes[((rtrUIntPtr)dest & 0x03)];
...
{
	register size_t remainder = align8bytes[((rtrUIntPtr)dest & 0x07)];
