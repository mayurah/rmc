...
template<class T>
class RTRAscSortedList
{
public:
// Constructors
	inline RTRAscSortedList() : _link(0) {};
		// _TAG Constructor

// Destructor
	inline ~RTRAscSortedList() {};
		// _TAG Destructor
...
private:
	RTRAscSortedList(const RTRAscSortedList<T>&);
	RTRAscSortedList<T>& operator=(const RTRAscSortedList<T>&);

};

#ifdef __INCLUDE_TEMPLATE_IMPL__
#ifdef __CSET__
#pragma implementation("raslist.C")
#else
#include "rtr/raslist.C"
#endif
#endif
