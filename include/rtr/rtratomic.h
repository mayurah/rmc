...
#ifdef _WIN32
	/**********************************************/
	/* Windows atomic operations VC6 and below    */
	/**********************************************/
...
#define RTR_ATOMIC_INCREMENT(___var)		(void)InterlockedIncrement(&___var)
#define RTR_ATOMIC_DECREMENT(___var)		(void)InterlockedDecrement(&___var)
#define RTR_ATOMIC_ADD(___var,___incr)		(void)InterlockedExchangeAdd(&___var,___incr)
#define RTR_ATOMIC_SET(___var,___newval)	(void)InterlockedExchange(&___var,___newval)

#define RTR_ATOMIC_INCREMENT_RET(___var)	InterlockedIncrement(&___var)
#define RTR_ATOMIC_DECREMENT_RET(___var)	InterlockedDecrement(&___var)
#define RTR_ATOMIC_ADD_RET(___var,___incr)	InterlockedExchangeAdd(&___var,___incr)

#define RTR_ATOMIC_SET_RETOLD(___var,___newval) \
		InterlockedExchange(&___var,___newval)

#define RTR_ATOMIC_COMPARE_AND_SWAP(___var,___compval,___newval) \
		InterlockedCompareExchange((LPLONG)&___var, ___compval, ___newval)

#ifdef COMPILE_64BITS
#error "Not setup to compile 64 bit on windows builds previous to vc71"
#endif

#define RTR_ATOMIC_COMPARE_AND_SWAPPTR(___pvar,___pcompval,___pnewval) \
		(void*)InterlockedCompareExchange((LPLONG)&___pvar,(LONG)___pnewval,(LONG)___pcompval)
...
extern void rtrInterIncr(rtr_atomic_val* ptrToVar);
extern void rtrInterDecr(rtr_atomic_val* ptrToVar);
extern void rtrInterAdd(rtr_atomic_val *ptrToVar, rtr_atomic_val increment);
extern void rtrInterExch(rtr_atomic_val* ptrToVal, rtr_atomic_val newval);
extern rtr_atomic_val rtrInterIncrRet(rtr_atomic_val* ptrToVar);
extern rtr_atomic_val rtrInterDecrRet(rtr_atomic_val* ptrToVar);
extern rtr_atomic_val rtrInterAddRet(rtr_atomic_val *ptrToVar, rtr_atomic_val increment);
extern rtr_atomic_val rtrInterExchRetOld(rtr_atomic_val* ptrToVal, rtr_atomic_val newval);

extern void rtrInterIncr64(rtr_atomic_val64* ptrToVar);
extern void rtrInterDecr64(rtr_atomic_val64* ptrToVar);
extern void rtrInterExch64(rtr_atomic_val64* ptrToVal, rtr_atomic_val64 newval);

#define RTR_ATOMIC_INCREMENT(___var)			rtrInterIncr(&___var)
#define RTR_ATOMIC_DECREMENT(___var)			rtrInterDecr(&___var)
#define RTR_ATOMIC_ADD(___var,___incr)			rtrInterAdd(&___var,___incr)
#define RTR_ATOMIC_SET(___var,___newval)		rtrInterExch(&___var,___newval)

#define RTR_ATOMIC_INCREMENT_RET(___var)		rtrInterIncrRet(&___var)
#define RTR_ATOMIC_DECREMENT_RET(___var)		rtrInterDecrRet(&___var)
#define RTR_ATOMIC_ADD_RET(___var,___incr)		rtrInterAddRet(&___var,___incr)

#define RTR_ATOMIC_INCREMENT_PTR(___var)			rtrInterIncr(___var)
#define RTR_ATOMIC_DECREMENT_PTR(___var)			rtrInterDecr(___var)
#define RTR_ATOMIC_ADD_PTR(___var,___incr)			rtrInterAdd(___var,___incr)
#define RTR_ATOMIC_SET_PTR(___var,___newval)		rtrInterExch(___var,___newval)

#define RTR_ATOMIC_INCREMENT_RET_PTR(___var)		rtrInterIncrRet(___var)
#define RTR_ATOMIC_DECREMENT_RET_PTR(___var)		rtrInterDecrRet(___var)
#define RTR_ATOMIC_ADD_RET_PTR(___var,___incr)		rtrInterAddRet(___var,___incr)

#define RTR_ATOMIC_SET_RETOLD(___var,___newval)	rtrInterExchRetOld(&___var,___newval)

/*
 * Solaris atomic_cas api calls are only supported on SunOS 5.10 U2 or later.
 */
#define RTR_ATOMIC_COMPARE_AND_SWAP(___var,___compval,___newval) \
	atomic_cas_32(&___var,___compval,___newval)

#define RTR_ATOMIC_COMPARE_AND_SWAPPTR(___pvar,___pcompval,___pnewval) \
	atomic_cas_ptr(&___pvar,___pcompval, ___pnewval)

#ifdef COMPILE_64BITS

/* On Solaris these are already implemented as quad words */
#define RTR_ATOMIC_INCREMENT64(___var)			rtrInterIncr(&___var)
#define RTR_ATOMIC_DECREMENT64(___var)			rtrInterDecr(&___var)
#define RTR_ATOMIC_SET64(___var,___newval)		rtrInterExch(&___var,___newval)
#define RTR_ATOMIC_ADD64(___var,___addend)		rtrInterAdd(&___var,___addend)
#define RTR_ATOMIC_READ64(___pvar)				(*(___pvar))

#define RTR_ATOMIC_INCREMENT64_PTR(___var)			rtrInterIncr(___var)
#define RTR_ATOMIC_DECREMENT64_PTR(___var)			rtrInterDecr(___var)
#define RTR_ATOMIC_SET64_PTR(___var,___newval)		rtrInterExch(___var,___newval)
#define RTR_ATOMIC_ADD64_PTR(___var,___addend)		rtrInterAdd(___var,___addend)

#else

#define RTR_ATOMIC_INCREMENT64(___var)			rtrInterExch64(&___var,___var+1)
#define RTR_ATOMIC_DECREMENT64(___var)			rtrInterExch64(&___var,___var-1)
#define RTR_ATOMIC_SET64(___var,___newval)		rtrInterExch64(&___var,___newval)
#define RTR_ATOMIC_ADD64(___var,___addend)		rtrInterExch64(&___var,___var+___addend)
#define RTR_ATOMIC_READ64(___pvar)				rtrAtomicRead64((___pvar)) // this assumes the variable is 64-bit aligned

#define RTR_ATOMIC_INCREMENT64_PTR(___var)			rtrInterExch64(___var,___var+1)
#define RTR_ATOMIC_DECREMENT64_PTR(___var)			rtrInterExch64(___var,___var-1)
#define RTR_ATOMIC_SET64_PTR(___var,___newval)		rtrInterExch64(___var,___newval)
#define RTR_ATOMIC_ADD64_PTR(___var,___addend)		rtrInterExch64(___var,___var+___addend)
...
{
	rtr_atomic_val64 dummyPrevValue = 0, dummyNewValue = 0;
	return (rtr_atomic_val64)(atomic_cas_64((volatile unsigned long long *)val, dummyNewValue, dummyPrevValue));
}
...
/*
#define RTR_ATOMIC_INCREMENT(___val)				___val+=1
#define RTR_ATOMIC_DECREMENT(___val)				___val-=1
#define RTR_ATOMIC_ADD(___val,___incr)				___val+=___incr
#define RTR_ATOMIC_SET(___val,___newval)			___val=___newval

#define RTR_ATOMIC_INCREMENT_RET(___val)			___val+=1
#define RTR_ATOMIC_DECREMENT_RET(___val)			___val-=1
#define RTR_ATOMIC_ADD_RET(___val,___incr)			___val+=___incr

#define RTR_ATOMIC_SET_RETOLD(___val,___newval)		___val=___newval
*/
